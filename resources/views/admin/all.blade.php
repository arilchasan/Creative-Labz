...
@section('container')
    ...
    <div class="card shadow m-2 p-3">
        <div class="card-header border-0 flex justify-between items-center">
            ...
            <a href="{{ route('admin.create') }}" class="btn btn-success ml-2 leading-2 px-3">+ Admin</a>
        </div>
        ...
        <div class="table-responsive">
            <table id="admin-table" class="table align-items-center table-flush ">
                <thead class="thead-light">
                    <tr>
                        <th scope="col" style="width: 10%">ID</th>
                        <th class="text-center" scope="col" style="width: 70%">Name</th>
        ...
        function deleteConfirmation(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/dashboard/user/delete/" + id;
                }
            })
        }
