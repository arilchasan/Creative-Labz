...
@section('container')
    ...
    <div class="card shadow m-2 p-3">
        <div class="card-header border-0 flex justify-between items-center">
            <h3 class="mb-0">Daftar Code Promo</h3>
            <a href="{{ route('promo.create') }}" class="btn btn-success ml-2 leading-2 px-3">+ Code</a>
        </div>
        ...
        <div class="table-responsive">
            <table id="code-table" class="table align-items-center table-flush ">
                <thead class="thead-light">
                    <tr>
                        <th scope="col" style="width: 40%">Code</th>
                        <th scope="col" style="width: 40%">Discount</th>
        ...
        function deleteConfirmation(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/dashboard/promo/delete-" + id;
                }
            })
        }
