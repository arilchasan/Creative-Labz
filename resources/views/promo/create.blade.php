...
<section class="p-5 mx-2 mt-2 shadow rounded">
    <h2 class="text-lg font-semibold capitalize">Tambah Code Promo</h2>

    <form action="/dashboard/promo/store" method="POST">
        @csrf
        <div class="row g-3 mt-2">
            ...
            <div class="col-md-12">
                ...
                <input id="discount" type="number" min="0" name="discount"
                    class="form-control" oninput="validity.valid||(value='');" required>
            </div>
        </div>
