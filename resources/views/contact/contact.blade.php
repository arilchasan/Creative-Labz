...
@section('container')
    ...
    <div class="card shadow m-2 p-3">
        <div class="card-header border-0 flex justify-between items-center">
            ...
            {{-- <a href="{{ route('user.create') }}" class="btn btn-success ml-2 leading-2 px-3">+ Admin</a> --}}
        </div>
        ...
        <div class="table-responsive">
            <table id="contact-table" class="table align-items-center table-flush ">
        ...
        function deleteConfirmation(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/dashboard/contact/delete-" + id;
                }
            })
        }
